...
public enum CoreErrorType {
    ...
    INVITATION_NOT_USABLE(CoreErrorCode.INVITATION002, CoreErrorKind.CONFLICT, "이미 사용되었거나 취소된 초대입니다.", CoreErrorLevel.WARN),
    INVITATION_EXPIRED(CoreErrorCode.INVITATION003, CoreErrorKind.CONFLICT, "만료된 초대 코드입니다.", CoreErrorLevel.WARN),
    ...
    OPENAI_NOT_CALLABLE(CoreErrorCode.OPENAI002, CoreErrorKind.SERVER_ERROR, "OpenAI 호출에 실패하였습니다", CoreErrorLevel.WARN),
